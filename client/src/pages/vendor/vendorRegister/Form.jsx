...
function VendorSignupForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const apiUrl = 'http://localhost:8800/auth/vendor/register';
    ...
    return (
        <div className="max-w-screen-xl mx-auto p-4 md:p-8 lg:p-12">
            <form onSubmit={handleSubmit} className="shadow-2xl p-4 md:p-8 lg:p-12 rounded-3xl bg-white bg-opacity-20">
                ...
                <div className='flex justify-center mt-5'><p>Already have an Account?<Link to={'/vendor/login'} style={{ color: 'blue' }}>Sign In</Link></p></div>
            </form>
        </div>
